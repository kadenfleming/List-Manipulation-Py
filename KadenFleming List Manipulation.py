...
shopping_list = []
#Start to main code printing all available options in terminal
while True:
    print("1. Add")
    print("2. Remove")
    print("3. Print list")
...
#Using if condition for option 1 if option 1 is sent as input prompt user to enter the item name into terminal
    if choice == "1":
        ...
        #Ending option 1 by printing msg to user that f most recent item was successfully added to the list
    elif choice == "2":
        ...
        if shopping_list:
            ...
            if 0 <= index < len(shopping_list):
                #Using user input number check index for correlating list item number
                ...
                #Print msg to user displaying "Item at correlating list number was removed
            else:
                print("Invalid item. Please enter a valid item.")
                #If no item was found with correlating number in list display "Invalid item. Please enter a valid item."
        else:
        ...
        if shopping_list:
            ...
            print("The list is empty.")
            #If list is empty print error msg "The list is empty."
    ...
    #If option 4 selected print full list with corresponding item numbers next to item once completed end program using break function to end program loop
        ...
        #If none of the available options were selected printing error msg to user


#Sources: Network Chuck Python Lists youtube series, Chat GPT for code reference and layout
#Comments: Used Network chuck series to understand and create shopping list variables, append function, elif/else/if, and general python list knowledge
# Chat GPT Used for code reference to understand correct order elif functions
